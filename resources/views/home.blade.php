...
<body>
    ...
    {{-- <div class="loader-wrapper">
        <i class="fa-solid fa-graduation-cap fa-beat" style="font-size: 100px"></i>
    </div> --}}
    {{-- Wolf loader --}}
    ...
    <div class="main-header">
        <div class="header-text">
            <h2>Welcome to the Coding Verse</h2>
            <h2>Learn <span id="change-text"></span></h2>
            <p>As the top freelancing service provider for educational content, my primary offering is to design,
                develop, and build digital educational solutions.</p>
            <a class='TIMdemo' href='#' target="_blank">Explore</a>
            <a class='TIMdownload' href='#' target="_blank">Get In Touch</a>
        </div>
        <div class="header-animation">
            {{-- <canvas id='canv'
                style="width: 100%; height:350px; clip-path: polygon(15% 0px, 100% 0%, 100% 100%, 0px 100%);"></canvas> --}}
            <img src="{{asset('assets/images/header-3.png')}}" alt="Computer Image" style="width: 100%; height:350px; clip-path: polygon(15% 0px, 100% 0%, 100% 100%, 0px 100%);">
        </div>
    </div>
    ...
    <div class="faqs-container container my-5 py-5" itemscope itemtype="https://schema.org/FAQPage">
...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <script>
        var typed = new Typed('#change-text', {
          strings: ['Python Development.', 'Javascript development.' , 'PHP Development.', 'MySQL Database.', 'Machine Learning.', 'User Interfaces.' , 'Data Analysis.'],
          typeSpeed: 120,
          loop: true,
        });
      </script>
